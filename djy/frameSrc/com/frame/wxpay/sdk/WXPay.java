...
public class WXPay {
    ...
    public String getSignTypeStr() {
	    ...
	    if ( "MD5".equals( this.signType.name() ) )
	        return WXPayConstants.MD5;
	    else if ( "HMACSHA256".equals( this.signType.name() ) )
   ...
   //-----------------------------------------------------------------
	...
	public Map<String, String> getSandboxSignKey() throws Exception {
		return this.getSandboxSignKey(config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
	}
	
	
	public Map<String, String> getSandboxSignKey(int connectTimeoutMs, int readTimeoutMs) throws Exception {
