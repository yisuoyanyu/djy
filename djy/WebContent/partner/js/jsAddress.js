...
{name:'上海', cityList:[		   
{name:'上海市', areaList:['川沙区','崇明区','闸北区','虹口区','杨浦区','徐汇区','长宁区','静安区','普陀区','黄浦区','卢湾区','奉贤区','南汇区','青浦区','松江区','金山区','浦东新区','嘉定区','宝山区','闵行区']}
]},
{name:'天津', cityList:[		   
{name:'天津市', areaList:['静海区','宁河区','和平区','河东区','河西区','汉沽区','大港区','东丽区','西青区','南开区','河北区','红桥区','塘沽区','滨海新区','北辰区','津南区','宝坻区','武清区','蓟县']}
]},
{name:'重庆', cityList:[		   
{name:'重庆市', areaList:['涪陵区','渝中区','万州区','万盛区','双桥区','南岸区','北碚区','沙坪坝区','九龙坡区','大渡口区','江北区','长寿区','黔江区','巴南区','渝北区','潼南县','綦江区','石柱土家族自治县','秀山土家族苗族自治县','酉阳土家族苗族自治县','彭水苗族土家族自治县','忠县','武隆县','云阳县','开县','巫山县','奉节县','巫溪县','大足区','铜梁县','璧山县','荣昌县','城口县','梁平县','垫江县','丰都县','江津区','永川区','合川区','南川区']}
]},
{name:'四川', cityList:[		   
...
{name:'潜江市', areaList:['园林办事处','杨市办事处','周矶办事处','广华办事处','泰丰办事处','高场办事处','竹根滩镇','渔洋镇','王场镇','高石碑镇','熊口镇','老新镇','浩口镇','积玉口镇','张金镇','龙湾镇','江汉石油管理局','潜江经济开发区','周矶管理区','后湖管理区','熊口管理区','总口管理区','白鹭湖管理区','运粮湖管理区','浩口原种场']},
{name:'仙桃市', areaList:['沙嘴街道办事处','干河街道办事处','龙华山办事处','郑场镇','毛嘴镇','豆河镇','三伏潭镇','胡场镇','长倘口镇','西流河镇','沙湖镇','杨林尾镇','彭场镇','张沟镇','郭河镇','沔城回族镇','通海口镇','陈场镇','工业园区','九合垸原种场','沙湖原种场','五湖渔场','赵西垸林场','畜禽良种场','排湖风景区']},
{name:'天门市', areaList:['竟陵街道办事处','侨乡街道开发区','杨林街道办事处','多宝镇','拖市镇','张港镇','蒋场镇','汪场镇','渔薪镇','黄潭镇','岳口镇','横林镇','彭市镇','麻洋镇','多祥镇','干驿镇','马湾镇','卢市镇','小板镇','九真镇','皂市镇','胡市镇','石河镇','佛子山镇','净潭乡','蒋湖农场','白茅湖农场','沉湖管委会']},
...
{name:'嘉峪关市', areaList:['新城镇','峪泉镇','文殊镇','雄关区','镜铁区','长城区']},		   
...
{name:'五家渠市', areaList:['军垦路街道办事处','青湖路街道办事处','人民路街道办事处','兵团一零一团','兵团一零二团','兵团一零三团']},
{name:'石河子市', areaList:['新城街道办事处','向阳街道办事处','红山街道办事处','老街街道办事处','东城街道办事处','北泉镇','石河子乡','兵团一五二团']},
{name:'阿拉尔市', areaList:['金银川路街道办事处','幸福路街道办事处','青松路街道办事处','南口街道办事处','托喀依乡','工业园区','兵团七团','兵团八团','兵团十团','兵团十一团','兵团十二团','兵团十三团','兵团十四团','兵团十六团','兵团第一师水利水电工程处','兵团第一师塔里木灌区水利管理处','阿拉尔农场','兵团第一师幸福农场','中心监狱']},
{name:'图木舒克市', areaList:['齐干却勒街道办事处','前海街道办事处','永安坝街道办事处','兵团四十四团','兵团四十九团','兵团五十团','兵团五十一团','兵团五十三团','兵团图木舒克市喀拉拜勒镇','兵团图木舒克市永安坝']}
]},
{name:'河北', cityList:[		   
...
{name:'海南', cityList:[
{name:'昌江黎族自治县',areaList:['石碌镇','叉河镇','十月田镇','乌烈镇','昌化镇','海尾镇','七叉镇','王下乡','国营红林农场','国营霸王岭林场','海南矿业联合有限公司']},
{name:'白沙黎族自治县',areaList:['牙叉镇','七坊镇','邦溪镇','打安镇','细水乡','元门乡','南开乡','阜龙乡','青松乡','金波乡','荣邦乡','国营白沙农场','国营龙江农场','国营邦溪农场']},
{name:'临高县',areaList:['临城镇','波莲镇','东英镇','博厚镇','皇桐镇','多文镇','和舍镇','南宝镇','新盈镇','调楼镇','国营红华农场','国营加来农场']},
{name:'澄迈县',areaList:['金江镇','老城镇','瑞溪镇','永发镇','加乐镇','文儒镇','中兴镇','仁兴镇','福山镇','桥头镇','大丰镇','国营红光农场','国营西达农场','国营金安农场']},
{name:'屯昌县',areaList:['屯城镇','新兴镇','枫木镇','乌坡镇','南吕镇','南坤镇','坡心镇','西昌镇','国营中建农场','国营中坤农场']},
{name:'定安县',areaList:['定城镇','新竹镇','龙湖镇','黄竹镇','雷鸣镇','龙门镇','龙河镇','岭口镇','翰林镇','富文镇','国营中瑞农场','国营南海农场','国营金鸡岭农场']},
{name:'中沙群岛的岛礁及其海域',areaList:['中沙岛礁']},
{name:'南沙群岛',areaList:['永暑岛']},
{name:'西沙群岛',areaList:['永兴岛']},
{name:'琼中黎族苗族自治县',areaList:['营根镇','湾岭镇','黎母山镇','和平镇','长征镇','红毛镇','中平镇','吊罗山乡','上安乡','什运乡','国营阳江农场','国营乌石农场','国营加钗农场','国营长征农场','国营黎母山林业公司']},
{name:'保亭黎族苗族自治县',areaList:['保城镇','什玲镇','加茂镇','响水镇','新政镇','三道镇','六弓乡','南林乡','毛感乡','国营新星农场','海南保亭热带作物研究所','国营金江农场','国营三道农场']},
{name:'陵水黎族自治县',areaList:['椰林镇','光坡镇','三才镇','英州镇','隆广镇','文罗镇','本号镇','新村镇','黎安镇','提蒙乡','群英乡','国营岭门农场','国营南平农场','国营吊罗山林业公司']},
{name:'乐东黎族自治县',areaList:['抱由镇','万冲镇','大安镇','志仲镇','千家镇','九所镇','利国镇','黄流镇','佛罗镇','尖峰镇','莺歌海镇','国营山荣农场','国营乐光农场','国营保国农场','国营尖峰岭林业公司','国营莺歌海盐场']},
{name:'文昌市',areaList:['文城镇','重兴镇','蓬莱镇','会文镇','东路镇','潭牛镇','东阁镇','文教镇','东郊镇','龙楼镇','昌洒镇','翁田镇','抱罗镇','冯坡镇','锦山镇','铺前镇','公坡镇','国营东路农场','国营南阳农场','国营罗豆农场']},
{name:'东方市',areaList:['八所镇','东河镇','大田镇','感城镇','板桥镇','三家镇','四更镇','新龙镇','天安乡','江边乡','国营广坝农场','东方华侨农场']},
{name:'万宁市',areaList:['万城镇','龙滚镇','和乐镇','后安镇','大茂镇','东澳镇','礼纪镇','长丰镇','山根镇','北大镇','南桥镇','三更罗镇','国营东兴农场','国营东和农场','国营新中农场','兴隆华侨农场','地方国营六连林场']},
{name:'五指山市',areaList:['通什镇','南圣镇','毛阳镇','番阳镇','畅好乡','毛道乡','水满乡','国营畅好农场']},
{name:'儋州市',areaList:['那大镇','和庆镇','南丰镇','大成镇','雅星镇','兰洋镇','光村镇','木棠镇','海头镇','峨蔓镇','三都镇','王五镇','白马井镇','中和镇','排浦镇','东成镇','新州镇','国营西培农场','国营西联农场','国营蓝洋农场','国营八一农场','洋浦经济开发区','华南热作学院']},
{name:'琼海市',areaList:['嘉积镇','万泉镇','石壁镇','中原镇','博鳌镇','阳江镇','龙江镇','潭门镇','塔洋镇','长坡镇','大路镇','会山镇','国营东太农场','国营东红农场','国营东升农场','彬村山华侨农场']},
{name:'三沙市',areaList:['西沙群岛','中沙群岛的岛礁及其海域','南沙群岛']},
{name:'海口市',areaList:['秀英区','琼山区','龙华区','美兰区']},
{name:'三亚市',areaList:['海棠湾镇','吉阳镇','凤凰镇','崖城镇','天涯镇','育才镇','国营南田农场','国营南新农场','国营立才农场','国营南滨农场','河西区街道办','河东区街道办']}
]},
{name:'台湾', cityList:[
{name:'台北',areaList:['']},
{name:'台中',areaList:['']},
...
{name:'香港', cityList:[
{name:'新界',areaList:['北区','沙田区','大埔区','葵青区','离岛区','屯门区','荃湾区','西贡区','元朗区']},
{name:'九龙',areaList:['黄大仙区','观塘区','九龙城区','油尖旺区','深水埗区']},
{name:'香港岛',areaList:['东区','湾仔','中西区','南区']}
]},
{name:'澳门', cityList:[
{name:'离岛',areaList:[]},
{name:'澳门半岛',areaList:[]}
