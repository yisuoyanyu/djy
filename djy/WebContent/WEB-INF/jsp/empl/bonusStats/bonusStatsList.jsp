...
<body>
	...
	<div class="view">
		...
		<table id="listView"
		       ...
		       data-url="bonusStats/bonusStatsListData.json?statsDate=${param.statsDate }"
		       data-id-field="id"
		       data-unique-id="id"
		       data-sort-name="id"
			...
			<thead>
				<th data-field="coPartnerName" data-width="25%">合作商家</th>
				<th data-field="totalCstmConsume" data-width="15%">会员消费总额（元）</th>
				<th data-field="maxSysDeposit" data-width="15%">平台最高预存限额（元）</th>
				<th data-field="indexPercent" data-width="10%">指标比例（%）</th>
				<th data-field="bonusPercent" data-width="10%">提成比例（%）</th>
				<th data-field="bonus" data-width="10%">提成金额（元）</th>
				<th data-field="statsDate" data-sortable="true" data-formatter="fmtDate" data-width="15%">统计日期</th>
			</thead>
		</table>
