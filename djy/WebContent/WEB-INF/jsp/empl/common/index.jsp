...
<head>
	...
	<%
		String basePath = request.getContextPath() + "/empl/";
	%>
					...
					<li class="nav-header">
						<div class="dropdown profile-element">
							...
							<a data-toggle="dropdown" class="dropdown-toggle" href="#">
								<span class="clear">
									<span class="block m-t-xs"><strong class="font-bold">工号：${loginEmpl.emplID}</strong></span>
									<span class="block m-t-xs"><strong class="font-bold">姓名：${loginEmpl.realName}</strong></span>
								</span>
							</a>
						</div>
