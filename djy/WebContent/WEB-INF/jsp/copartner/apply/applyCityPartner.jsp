...
<style>
  ...
  <body class="bg_white">
    ...
    <div data-am-widget="titlebar" class="am-titlebar am-titlebar-default">
      <h2 class="am-titlebar-title " style="color:#3a88ed;font-weight:bolder;">城市合伙人在线申请表</h2></div>
    
	<form class="am-form am-form-horizontal" id="applyCityPartnerForm" method="post" enctype="multipart/form-data">
	...
	<script type="text/javascript">	
		...
		function submit(){
			if ( !checkSubmit() )
				return false;
			$.post(
				"apply/saveApplyCityPartner.do", 
				$('#applyCityPartnerForm').serializeArray(),
				function(ret){
					if(ret.success){
						$.alert('提交成功');
						window.history.go(-1);
