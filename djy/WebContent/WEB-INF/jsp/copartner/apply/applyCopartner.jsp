 ...
 <style>
  ...
  <body class="bg_white">
    ...
    <div class="am-slider am-slider-a1" data-am-flexslider="{playAfterPaused: 8000}" style="-webkit-box-shadow: 0 1px 4px rgba(0, 0, 0, 0);">
      <ul class="am-slides">
        <li>
          <img src="../copartner/img/joinin3banner.png"></li>
      </ul>
    </div>
    <div data-am-widget="titlebar" class="am-titlebar am-titlebar-default">
      <h2 class="am-titlebar-title " style="color:#3a88ed;font-weight:bolder;">商家入驻在线申请表</h2></div>

	<form class="am-form am-form-horizontal" id="applyCopartnerForm" method="post" enctype="multipart/form-data">
  <!-- am-form-group 的基础上添加了 am-form-group-sm -->
  <div class="am-form-group am-form-group-sm" style="margin-bottom:0rem;">
    <label for="doc-ipt-3-1" class="am-u-sm-4 am-form-label join-formlabel" style="text-align:left;">商品类别</label>
    <div class="am-u-sm-8" style="padding-left:0rem;">
       <div class="am-form-group">
      <select data-am-selected style="width:100%;" name="catg" id="catg">
	  <option value="加油站">加油站</option>
	  <option value="KTV" selected>KTV</option>
	  <option value="饭店">饭店</option>
	  <option value="游乐场">游乐场</option>
	  <option value="购物城">购物城</option>
	 </select>
    ...
    <label for="doc-ipt-3-1" class="am-u-sm-4 am-form-label join-formlabel" style="text-align:left;">所在城市</label>
    <div class="am-u-sm-8" style="padding-left:0rem;">
	...
	<script type="text/javascript">	
		...
		function submit(){
			if ( !checkSubmit() )
				return false;
			$.post(
				"apply/saveApplyCopartner.do", 
				$('#applyCopartnerForm').serializeArray(),
				function(ret){
					if(ret.success){
						$.alert('提交成功');
						window.history.go(-1);
