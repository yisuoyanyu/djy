    ...
    <ul class="am-list am-margin-xs" id="detaildiv">
    	...
    	<li name="csli">
		   <div style="margin-left: 0rem;">
		    <div class="am-cf">
		     <span class="am-fl">${i.coPartner.name}</span>
		     <span class="am-fr red">提成：￥<fmt:formatNumber value="${i.bonus}" pattern="0.00" type="number" /></span>
		    </div>
		    <div class="am-cf">
		     <span class="am-fl am-text-sm gray">指标：￥<fmt:formatNumber value="${i.maxSysDeposit * i.indexPercent}" pattern="0.00" type="number" /></span>
		     <span class="am-fr am-text-sm gray">营业额:￥<fmt:formatNumber value="${i.totalCstmConsume}" pattern="0.00" type="number" /></span>
		    </div>
		    <div class="am-cf">
		     <span class="am-fl am-text-sm gray"><fmt:formatDate pattern="yyyy/MM/dd HH:mm" value="${i.insertTime}" /></span>
		     <span class="am-fr am-text-sm gray">提成比:<fmt:formatNumber value="${i.bonusPercent}" pattern="0.00" type="number" /></span>
		    </div>
		   </div>
       </li>
    </c:forEach>
