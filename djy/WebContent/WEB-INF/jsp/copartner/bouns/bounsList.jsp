...
<html class="no-js">
  ...
  <div class="bg_topmain" id="topmain"> 
   ...
   <div style="float: right;margin-right: 1vw;" onclick="javascript:window.location.href='bouns/bounsMonthList.do?page=1'">
	   <i class="icon iconfont icon-monthTotalCount" style="color: white;"><span style="font-size: 5vw;vertical-align: middle;color: white;">月统计</span></i>
   </div>
