...
<body>
		...
		<div id="panel_search_cont" class="panel-body">
			...
			<div class="form-horizontal">
				<div class="form-group col-sm-4">
					<label class="control-label col-sm-4" for="txt_search_username">用户名称</label>
					<div class="col-sm-8">
				...
				<div class="form-group col-sm-4">
					<label class="control-label col-sm-4" for="txt_search_mobile">用户电话</label>
					<div class="col-sm-8">
	...
	<div class="view">
		...
		<table id="listView"
		       ...
		       data-url="user/userListData.json"
		       data-id-field="id"
		       data-unique-id="id"
		       data-sort-name="id"
			...
			<thead>
				<th data-field="username" data-width="25%">会员名称</th>
				<th data-field="mobile" data-width="20%">会员电话</th>
			...
			'onClickRow' : function(row, $element, field) {       // 行点击事件
				if ( field != 0 ) {
					openWin({
				        'title' : '用户详情',
				        'target' : 'menuTab',
				        'url' : 'user/userRecord.do?id=' + row.id
				    });
				}
			}
		});
