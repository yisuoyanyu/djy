...
<body>
		...
		<div id="panel_search_cont" class="panel-body">
			...
			<div class="form-horizontal">
				...
				<div class="form-group col-sm-8">
					<label class="control-label col-sm-2 text-nowrap">活动时间</label>
					<div class="col-sm-10">
						<div class="form-group col-sm-6">
							<div class="input-group">
								<div class="input-group-addon">从</div>
								<input type="text" class="input-sm form-control layer-date" id="txt_search_startTime" placeholder="开始日期" onfocus="this.blur();">
							</div>
						</div>
						<div class="form-group col-sm-6">
							<div class="input-group">
								<div class="input-group-addon">至</div>
								<input type="text" class="input-sm form-control layer-date" id="txt_search_endTime" placeholder="结束日期" onfocus="this.blur();" >
							</div>
						</div>
					</div>
				</div>
	...
	<div class="view">
		...
		<table id="listView"
		       ...
		       data-url="actCoupon/actCouponListData.json"
		       data-id-field="id"
		       data-unique-id="id"
		       data-sort-name="id"
			...
			<thead>
				...
				<th data-field="typeName" data-width="10%">优惠券类型</th>
	...
	$(function() {
			...
			slideUpSearch({
				callback : function() {
					...
					oListView.search({
						...
						'insertTimeStart' : $('#txt_search_startTime').val(),
						'insertTimeEnd' : $('#txt_search_endTime').val()
					});
		...
		$('#btn_add').click(function() {
			openWin({
		        'title' : '新增送券活动',
		        'target' : 'menuTab',
		        'url' : 'actCoupon/actCouponRecord.do'
		    });
		});
