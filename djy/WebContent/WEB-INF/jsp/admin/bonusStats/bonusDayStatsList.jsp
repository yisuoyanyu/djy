	...
	<div class="view">
		...
		<table id="listView"
			...
			<thead>
				...
				<th data-field="emplID" data-width="10%">工号</th>
				<th data-field="emplName" data-width="10%">姓名</th>
				<th data-field="totalCstmConsume" data-width="15%">会员消费总额（元）</th>
				<th data-field="bonus" data-width="15%">提成总额（元）</th>
			</thead>
		</table>
			...
			'onClickRow' : function(row, $element, field) {       // 行点击事件
				if ( field != 0 ) {
					 openWin({
				        'title' : '提成统计信息',
				        'target' : 'menuTab',
				        'url' : 'bonusStats/bonusStatsList.do?statsDate=' + row.statsDate +'&emplID=' + row.emplID
					 });
				}
			}
		});
