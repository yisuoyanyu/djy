				...
				<div class="ibox-content">
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-6 form-group">
								<label class="control-label col-sm-4" for="amount">支付金额</label>
								<div class="col-sm-8">
									<p class="form-control-static">
										<fmt:formatNumber value="${ consumeOrder.payAmount }" type="number" maxFractionDigits="2" /> 元
									</p>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-sm-6 form-group">
								...
								<div class="col-sm-8">
									<p class="form-control-static">${ consumeOrder.coPartner.name }</p>
								</div>
							</div>
