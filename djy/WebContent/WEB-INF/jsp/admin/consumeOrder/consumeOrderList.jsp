...
<body>
		...
		<div id="panel_search_cont" class="panel-body">
			...
			<div class="form-horizontal">
				...
				<div class="form-group col-sm-4">
					<label class="control-label col-sm-4" for="txt_search_userMobile">用户手机号</label>
					<div class="col-sm-8">
				...
				<div class="form-group col-sm-4">
					<label class="control-label col-sm-4" for="txt_search_nickname">用户名</label>
					<div class="col-sm-8">
	...
	<div class="view">
		...
		<table id="listView"
			...
			<thead>
				<th data-field="no" data-width="10%">订单编号</th>
				<th data-field="nickname" data-width="15%">用户名称</th>
				<th data-field="mobile" data-width="15%">用户手机号</th>
				<th data-field="coPartnerName" data-width="15%">商家名称</th>
