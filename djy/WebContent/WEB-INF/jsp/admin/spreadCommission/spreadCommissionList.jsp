...
<body>
		...
		<div id="panel_search_cont" class="panel-body">
			...
			<div class="form-horizontal">
				...
				<div class="form-group col-sm-4">
					<label class="control-label col-sm-4" for="txt_search_realName">推广人</label>
					<div class="col-sm-8">
				...
				<div class="form-group col-sm-4">
					<label class="control-label col-sm-4" for="txt_search_mobile">推广人手机</label>
					<div class="col-sm-8">
	...
	<div class="view">
		...
		<div id="toolbar" class="btn-group" role="group">
			<input id="status" value="${param.status }" type="hidden"/>
			<h4>
				推广佣金总额：<span id="totalAmount"></span>元
			</h4>
		</div>
		
		<table id="listView"
		       data-toolbar="#toolbar"
		       data-url="spreadCommission/spreadCommissionListData.json?status=${param.status }"
		       data-id-field="id"
		       data-unique-id="id"
		       data-sort-name="id"
			...
			<thead>
				<th data-field="realName" data-width="20%">推广人</th>
				<th data-field="mobile" data-width="15%">推广人手机</th>
...
<script type="text/javascript">
	...
	$(function() {
			...
			'onClickRow' : function(row, $element, field) {       // 行点击事件
				if ( field != 0 ) {
					 openWin({
				        'title' : '推广佣金详情',
				        'target' : 'menuTab',
				        'url' : 'spreadCommission/spreadCommissionRecord.do?id=' + row.id
					 });
				}
			}
		});
		...
		function searchCommissionAmount(flag){
			...
			$.ajax({
				type : 'POST',
				url : 'spreadCommission/countCommissionTotalAmount.do',
				data : {
