...
<body>
		...
		<div id="panel_search_cont" class="panel-body">
			...
			<div class="form-horizontal">
				...
				<div class="form-group col-sm-4">
					<label class="control-label col-sm-4" for="txt_search_username">用户名</label>
					<div class="col-sm-8">
	...
	<div class="view">
		...
		<div id="toolbar" class="btn-group" role="group">
			...
			<c:if test="${not empty DelSysUser }">
		...
		<table id="listView"
		       ...
		       data-url="sysUser/sysUserListData.json"
		       data-id-field="id"
		       data-unique-id="id"
		       data-sort-name="id"
			...
			<thead>
				...
				<th data-field="username" data-sortable="true" data-width="15%">用户名</th>
				<th data-field="realName" data-sortable="true" data-width="20%">真实姓名</th>
				<th data-field="mobile" data-width="25%">手机</th>
				<th data-field="sysRoleName" data-width="15%">角色</th>
			...
			'onClickRow' : function(row, $element, field) {       // 行点击事件
				if ( field != 0 ) {
					 openWin({
				        'title' : '工作人员详情',
				        'target' : 'menuTab',
				        'url' : 'sysUser/sysUserRecord.do?id=' + row.id
					 });
				}
			}
		});
		...
		$('#btn_freeze').click(function() {
			...
			Confirm({
				...
				ok : function() {
					...
					$.ajax({
						type : "POST",
						url : "sysUser/freezeSysUser.json",
						data : {
							'ids' : ids
						},
						dataType : "json",
		...
		$('#btn_normal').click(function() {
			...
			Confirm({
				...
				ok : function() {
					...
					$.ajax({
						type : "POST",
						url : "sysUser/normalSysUser.json",
						data : {
							'ids' : ids
						},
						dataType : "json",
