...
<body>
	...
	<div class="view">
		...
		<table id="listView"
		       ...
		       data-url="coPartnerTag/coPartnerTagListData.json"
		       data-id-field="id"
		       data-unique-id="id"
		       data-sort-name="id"
			...
			<thead>
				...
				<th data-field="typeName"  data-width="25%">类型</th>
	...
	$(function() {
		...
		$('#btn_add').click(function() {
			openWin({
		        'title' : '新增商品标签',
		        'target' : 'menuTab',
		        'url' : 'coPartnerTag/coPartnerTagRecord.do'
		    });
		});
