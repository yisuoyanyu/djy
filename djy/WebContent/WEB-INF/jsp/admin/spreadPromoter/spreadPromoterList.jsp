...
<body>
	...
	<div id="panel_search" class="panel panel-default panelSearch">
		...
		<div id="panel_search_cont" class="panel-body">
			...
			<div class="form-horizontal">
				...
				<div class="form-group col-sm-4">
					<label class="control-label col-sm-4" for="txt_search_realName">姓名</label>
					<div class="col-sm-8">
	...
	<div class="view">
		...
		<table id="listView"
		       ...
		       data-url="spreadPromoter/spreadPromoterListData.json"
		       data-id-field="id"
		       data-unique-id="id"
		       data-sort-name="id"
			...
			<thead>
				...
				<th data-field="realName" data-sortable="true" data-width="15%">姓名</th>
				<th data-field="mobile" data-width="15%">手机</th>
				<th data-field="spreadConsumeFirstComm" data-width="30%">推广首次消费佣金（元）</th>
	...
	$(function() {
			...
			'onClickRow' : function(row, $element, field) {       // 行点击事件
				if ( field != 0 ) {
					 openWin({
				        'title' : '推广人详情',
				        'target' : 'menuTab',
				        'url' : 'spreadPromoter/spreadPromoterRecord.do?id=' + row.id
					 });
				}
			}
		});
		...
		$('#btn_add').click(function() {
			openWin({
		        'title' : '新增推广人',
		        'target' : 'menuTab',
		        'url' : 'spreadPromoter/spreadPromoterRecord.do'
		    });
		});
		...
		$('#btn_freeze').click(function() {
			...
			Confirm({
				...
				ok : function() {
					...
					$.ajax({
						type : "POST",
						url : "spreadPromoter/freezeSpreadPromoter.json",
						data : {
							'ids' : ids
						},
						dataType : "json",
		...
		$('#btn_normal').click(function() {
			...
			Confirm({
				...
				ok : function() {
					...
					$.ajax({
						type : "POST",
						url : "spreadPromoter/normalSpreadPromoter.json",
						data : {
							'ids' : ids
						},
						dataType : "json",
		...
		$('#btn_del').click(function() {
			...
			Confirm({
				...
				ok : function() {
					...
					$.ajax({
						type : "POST",
						url : "spreadPromoter/delSpreadPromoter.json",
						data : {
							'ids' : ids
						},
						dataType : "json",
