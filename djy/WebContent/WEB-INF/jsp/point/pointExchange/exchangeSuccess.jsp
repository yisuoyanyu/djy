...
<html class="no-js">
  ...
  <div class="success_main_div"> 
   ...
   <div class="success_maindown_div"> 
    <span class="success_maindown_span">兑换成功!</span>
    <br /> 
   </div> 
   <div class="success_pay_div"> 
    <div class="success_pay_left_div"> 
     <div class="success_pay_leftin_div"> 
      <span class="success_payup_span">本次兑换</span>
      <br /> 
      <span class="success_paydown_span">${point}</span> 
     </div> 
    </div> 
    <div class="success_pay_right_div"> 
     <div class="success_pay_leftin_div"> 
      ...
      <br /> 
      <span class="success_paydown_span">${user.userAccount.point}</span> 
     </div> 
    </div> 
   </div> 
  </div> 
