...
<html class="no-js">
    ...
    <div class="bar h3 tabs_bar posi_fixed border_b" style="height: 5rem;background-color: #476df6;">
      <ul class="am-avg-sm-3" style="border-bottom: 0px solid #DDDDDD; height: 5rem;position: fixed;z-index: 999;">
        <li class="on" style="height: 5rem;">
          <a href="javascript:void(0);" style="height: 5rem; line-height: 5rem;">未付款</a></li>
        <li style="height: 5rem;">
          <a href="javascript:location.replace('order/ordersPaySuccess.do');" style="height: 5rem; line-height: 5rem;">付款成功</a></li>
        <li style="height: 5rem;">
          ...
          <div class="am-accordion-content" style="overflow:hidden">
            <div style="width:100%">
              <div class="half_left">
                <div class="order_mian_font">
                  <span>购买积分</span></div>
                <div class="order_mian_font">
                  <span id="point">${i.point}</span></div>
              </div>
            ...
            <div class="order_pay_div">
              <div class="pointDetail_topleft_div">
                <button class="order_button" id="${i.orderId}" onclick="cancelOrder(this);">取消订单</button></div>
              <div class="success_pay_right_div">
                <button class="order_button" id="${i.no}" style="background-color:red" onclick="goonPay(this);">继续支付</button></div>
            </div>
          </div>
        </dd>
      </dl>
    ...
    <script type="text/javascript">
				...
				ok : function() {
					...
					$.ajax({
						...
						success : function(data) {
							if (data.success) {
								 location.replace('order/ordersCancel.do');
							}
						}
					});
				},
      ...
      function goonPay(th){
    	  ...
    	  var orderNo = th.id;
    	  window.location="pointBuy/pointCostBuyConfirm.do?orderNo="+orderNo;
      }
