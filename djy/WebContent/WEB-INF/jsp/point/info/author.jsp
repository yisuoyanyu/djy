...
<html class="no-js">
  ...
  <div class="point_shalow_div"> 
   ...
   <input id="id" name="id" type="hidden" value="${ user.coPartner.id }" />
   <div class="lidiv" style="border-bottom:solid 1px #c9c9c9;position:relative"> 
    <div class="bus_mian_inputdiv"> 
     ...
     <div class="bus_main_nameinputdiv"> 
      <input class="bus_main_nameinput" type="text" name="name" id="name" onkeyup="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5\ ]/g,'')" placeholder="请输入加油站名" /> 
     </div> 
    </div> 
   </div> 
   <div class="lidiv" style="border-bottom:solid 1px #c9c9c9;position:relative"> 
    <div class="bus_mian_inputdiv"> 
     ...
     <div class="bus_main_nameinputdiv"> 
      <input class="bus_main_nameinput" type="text" name="contact" id="contact" onkeyup="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5\ ]/g,'')" placeholder="请输入联系人姓名" /> 
     </div> 
    </div> 
   </div> 
   <div class="lidiv" style="border-bottom:solid 1px #c9c9c9;position:relative"> 
    <div class="bus_mian_inputdiv"> 
     ...
     <div class="bus_main_nameinputdiv"> 
      <input class="bus_main_nameinput" type="number" name="contactMobile" id="contactMobile" onchange="checkContactMobile();" placeholder="请输入联系人电话" /> 
     </div> 
    </div> 
   </div> 
   <div class="lidiv" style="border-bottom:solid 1px #c9c9c9;position:relative"> 
    <div class="bus_mian_inputdiv"> 
     ...
     <div class="bus_main_nameinputdiv"> 
      <input class="bus_main_nameinput" type="tel" name="telephone" id="telephone" onchange="checkphone();" placeholder="请输入座机" /> 
     </div> 
    </div> 
   </div> 
   <div class="lidiv" style="border-bottom:solid 1px #c9c9c9;position:relative"> 
    <div class="bus_mian_inputdiv"> 
     ...
     <div class="bus_main_nameinputdiv"> 
      <input class="bus_main_nameinput" type="text" name="businessUicenseNo" id="businessUicenseNo" placeholder="请输入营业执照注册号" /> 
     </div> 
    </div> 
   </div>
    ...
    <div class="bus_mian_inputdiv"> 
     ...
     <div class="bus_main_nameinputdiv"> 
      <input class="bus_main_nameinput" type="text" name="slogan" id="slogan" placeholder="请输入您的油站广告语" /> 
     </div> 
    </div> 
   </div>
   ...
   <div class="bus_mian_div">
    ...
    <div style="padding-bottom: 1vw"><input id="where" name="where" type="text" style="border-left-width:0px;border-top-width:0px;border-right-width:0px;border-bottom-color:black">  
  <input type="button" class="bindPhone_codebutton" value="地图上找" onClick="sear(document.getElementById('where').value);" />  
   </div>
   </div>
    ...
    <div class="bus_mian_inputdiv"> 
     ...
     <div class="bus_main_nameinputdiv">  
     <input id="province" name="province" readonly="readonly" type="text" class="bus_main_nameinput" style="width: 20%" placeholder="省"/>
     <input id="city" name="city" readonly="readonly" type="text" class="bus_main_nameinput" style="width: 20%" placeholder="市" />
     <input id="county" name="county" readonly="readonly" type="text" class="bus_main_nameinput" style="width: 20%" placeholder="县/区"/>
     </div> 
    </div> 
   </div>
   <div class="lidiv" style="border-bottom:solid 1px #c9c9c9;position:relative"> 
    <div class="bus_mian_inputdiv"> 
     ...
     <div class="bus_main_nameinputdiv"> 
      <input class="bus_main_nameinput" type="text" name="town" id="town" placeholder="请输入公司街道" /> 
     </div> 
    </div> 
   </div> 
    <div class="lidiv" style="border-bottom:solid 1px #c9c9c9;position:relative"> 
    <div class="bus_mian_inputdiv"> 
     ...
     <div class="bus_main_nameinputdiv"> 
      <input class="bus_main_nameinput" type="text" name="address" id="address" placeholder="请输入公司详细地址" /> 
     </div> 
    </div> 
   </div>
   <div class="lidiv" style="border-bottom:solid 1px #c9c9c9;position:relative;display: none;"> 
    <div class="bus_mian_inputdiv"> 
     ...
     <div class="bus_main_nameinputdiv"> 
      <input class="bus_main_nameinput" readonly="readonly" type="hidden" name="lon" style="width: 30%" id="lon" placeholder="经度" /> 
        <input class="bus_main_nameinput" readonly="readonly" type="hidden" name="lat" style="width: 30%" id="lat" placeholder="纬度" /> 
...
$(function(){ 
			    ...
			    wx.getLocation({
			        ...
			        success: function (res) {
			        	...
			        	myCity.get( function(result){
			        	    // 初始化地图,设置中心点坐标和地图级别 
			        	    map.centerAndZoom(new BMap.Point(currentLon, currentLat), result.level); 
			        	    //添加地图类型控件
	...
	function checkSubmit() {
		...
		var fnames = ['加油站名', '联系人', '联系人电话','身份证','营业执照','广告语','省份','城市','县/区','街道','详细地址','经度','纬度'];
			...
			function(ret){
				if(ret.success){
					Alert({
						msg : '提交成功',
						ok : function() {
							location.replace('info/myInfo.do');
						}
					});
				} else {
					alert(ret.data);
